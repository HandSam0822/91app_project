"use strict"
/**
 * Send XMLHttpRequest(GET) to socialnetwork/get-follower.
 * xhr.responseText expect to be json-like string that send by 
 * <get_follower_post_json_dumps_serializer> from views.py
...
/**
 * If xhr is valid, run updatePostHelper to update follower's posts and comments 
 ...
 * following posts and comments data
    ...
    for (let i = 0; i < posts.length; i++) {           
        ...
        if (document.getElementById("id_post_and_comment_div_"+ post['id']) == null) {                    
            ...
            setAttributes(submit_input, {
                ...
                "type": "submit",
                "onclick": "addFollowerComment(" + post.id + ")"
            })
 ...
 */
function addFollowerComment(id) {
    ...
    xhr.open("POST", 'add-follower-comment', true);
